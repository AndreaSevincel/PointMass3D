...
\begin{itemize}\itemsep2pt
  ...
  the residual does not predict what a mechanism is worth: two arms that are
...
segment from start to goal on the identical problems, which the world-frame arm

...
optimization-based~\cite{zucker2013chomp,schulman2014trajopt} planners act
...
inference time. We use RRT-Connect, CHOMP and TrajOpt both to generate expert
trajectories and to bound what is achievable on our benchmark.
...
matching~\cite{lipman2023fm,liu2023rectified,albergo2023interpolants} replaces
...
widely~\cite{simeonov2022ndf,ryu2023edf,urain2023se3dif,wang2024equidp,yang2024equibot}.
...
\midrule
\multicolumn{5}{l}{\emph{second state space}: $\SE$ rigid body, floor $4.8$}\\
            & $20$ ep.       & 2.8 & 6.2 & $+3.4$ \\
            & ${\sim}156$ ep.& 3.1 & \textbf{10.0} & $+6.9$ \\
\midrule
\multicolumn{5}{l}{\emph{other objective}: DDPM, matched network evaluations}\\
            & $20$ ep.       & 12.27 & 28.97 & $+16.71$ \\
            & $300$ ep.      & 13.51 & 50.52 & $\mathbf{+37.01}$ \\
\midrule
\multicolumn{5}{l}{\emph{other clutter}: obstacles per environment}\\
            & $8$            & 61.4 & 90.8 & $+29.4$ \\

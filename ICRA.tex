...
\begin{abstract}
\noindent
Equivariance to rigid-body transformations underwrites generalisation in
...
by any continuous rule. Of the three mechanisms available for it, neither of the
two run to convergence recovered a point, and the third was already not
significant at a fixed budget. The constrained architecture was not idle: it reached any given

...
\begin{equation}
  T_{\mathcal{P}}(\svec) = \big({-\tfrac{\ell}{2}},\, 0,\, 0\big),
  \qquad
  T_{\mathcal{P}}(\gvec) = \big({+\tfrac{\ell}{2}},\, 0,\, 0\big).
  \label{eq:endpoints}
\end{equation}
...
\begin{equation}
  T_{T\mathcal{P}} \circ T \;=\; R_1(\theta) \circ T_{\mathcal{P}} .
  \label{eq:residual}
\end{equation}
\end{proposition}
\begin{proof}
$\|T\gvec - T\svec\| = \ell$, so by Eq.~\eqref{eq:endpoints} both
$T_{T\mathcal{P}} \circ T$ and $T_{\mathcal{P}}$ carry $\svec$ to
$(-\tfrac{\ell}{2},0,0)$ and $\gvec$ to $(+\tfrac{\ell}{2},0,0)$. Their composite
$A = T_{T\mathcal{P}} \circ T \circ T_{\mathcal{P}}^{-1}$ is therefore an

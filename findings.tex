...
40  & 44.6 & 37.9 & $+6.7$ \\
100 & 48.7 & 45.8 & $+2.9$ \\
300 & 50.9 / 51.6 & 50.8 / 51.6 & $+0.05$ \\
\bottomrule
\end{tabular}
\end{center}
\ev{seed-matched at 300 epochs, n=2; reaches at epoch 10 what the unconstrained
...
\begin{tabular}{lrrr}
\toprule
60 envs, 300 epochs & No local geom. & $+$ local geom. & Geometry adds \\
\midrule
World frame               & 14.6 & 54.5 & $+39.9$ \\
$(s,g)$ reduction         & 50.8 & 79.2 & $+28.4$ \\
$+$ equivariant backbone  & 50.9 & 82.2 & $+31.3$ \\
\bottomrule
\end{tabular}
\end{center}
\ev{geometry cells are currently n=1 -- see N1}
...
\ev{a gauge y(x) perpendicular to x is exactly a unit tangent field on S^2;
x covers all of S^2 here, so there is no contractible-domain escape; every
deterministic gauge jumps somewhere -- for the smallest-component cross-product
construction the jump is 60--120 degrees}
...
preserves every radius and sends phi -> phi + pi, so E[c_m] = 0 for every ODD m
and every axis direction}

...
this is budget --- the model is small ($2.16$M parameters), briefly trained ($20$
epochs), and no train--validation gap appeared in any run, so it is underfitting
rather than overfitting --- and part is that a $64$-waypoint unconditional-prior
...
anything. The claim we make is comparative and holds at every point of the scaling

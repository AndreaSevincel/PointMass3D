...
\midrule
$(\svec,\gvec)$ reduction (5 DOF) & $+30.1$ & $+36.5$ & $\pm0.4$ / $\pm0.3$, $n{=}3$ \\
\quad of which: 3 translations    & $+12.3$ & --- & recentring alone \\
\quad of which: 2 rotations       & $+18.0$ & --- & aligning the axis \\
$\SE$ augmentation (world frame)  & $+2.1$  & --- & real, but $7\%$ of the above \\
Roll augmentation                 & $+0.8$  & --- & $\pm0.3$ paired, $n{=}3$; n.s. \\
Frame averaging ($K{:}1\!\to\!3$) & $+0.1$  & $+0.68$ & $\pm0.13$ converged, $n{=}3$ \\
\bottomrule
\end{tabular}
...
\begin{tabular}{lrrr}
\toprule
$60$ environments & Global only & $+$ local & $\Delta$ \\
\midrule

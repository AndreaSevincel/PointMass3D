...
converges to \emph{at or below} the $15.6\%$ obtained by joining start to goal
with a straight line on the identical problems: the point estimate is lower, and
the two are within the clustered bootstrap's $2.2$-point standard error on that
rate, so the defensible claim is that training on world coordinates does not beat
the trivial baseline rather than that it loses to it.
...
\midrule
World frame               & $13.2$ & $14.4$ & $14.2$ & $14.60$ & $+0.1$ \\
$(\svec,\gvec)$ reduction & $31.4$ & $42.3$ & $48.3$ & $\mathbf{51.10}$ & $+0.2$ \\
\midrule
Gap                       & $18.2$ & $27.9$ & $34.1$ & $\mathbf{+36.5}$ & \\
\bottomrule
\end{tabular}
\end{center}

...
It reaches $16.15\%$ against the world frame's $14.60\pm0.20$, a single seed
against three. \emph{Query-dependence alone is worth under two points of the
$36.5$}, and canonicalisation supplies the remaining $35.0$. The deflationary
reading is not supported: a query-dependent scene code is necessary for the
mechanism described above, and nowhere near sufficient for the effect. It is
also, at $16.15\%$, the first world-frame arm we have measured that is not below
the straight-line floor, which is consistent with query-dependence being a real
but small ingredient.
